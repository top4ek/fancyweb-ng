...
export default function Select({ label, options }: SelectProps) {
  return (
    <div className="rounded-md flex flex-col bg-wallet-bg w-full border border-wallet-border">
      <p className="text-sm text-dark-grey ml-1 mt-0.5 w-fit truncate">{label}<sup className="text-red"> *</sup></p>
      ...
      <p className="text-red text-xs pl-2 w-fit">Error description</p>
    </div>
  );
}
