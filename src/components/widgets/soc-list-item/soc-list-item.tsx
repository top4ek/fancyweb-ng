...
export default function SoCListItem(props: SoCItemProps) {
  ...
  return (
    <li className="grid grid-cols-5 grid-rows-4 border border-wallet-border rounded-sm md:flex md: flex-row md:flex-nowrap md:border-0 md:border-b md:gap-x-1 md:min-h-11">
      ...
      <p className="col-start-1 col-end-4 row-start-2 row-end-3 bg-wallet-bg mb-1 mr-1 pb-1 text-center md:min-w-56 md:text-left md:grow-[56] md:m-0 md:p-0 md:pl-2 md:content-center">
        {model}
      </p>
      ...
      <p className="col-start-4 col-end-6 row-start-2 row-end-3 bg-wallet-bg mb-1 pb-1 text-center md:min-w-32 md:text-left md:grow-[32] md:m-0 md:p-0 md:pl-2 md:content-center">
        {address}
      </p>
      ...
      <p className="col-start-1 col-end-2 row-start-4 row-end-5 bg-wallet-bg mr-1 pb-1 flex flex-row justify-center md:min-w-14 md:grow-[14] md:m-0 md:p-0 md:flex-col md:items-center *:w-[33px] *:h-[22px]">
        <StageIcon />
      </p>
      ...
      <p className="col-start-2 col-end-6 row-start-4 row-end-5 pb-1 bg-wallet-bg text-center md:min-w-72 md:text-left md:grow-[72] md:p-0 md:pl-2 md:content-center">
        {installation
